...
┗━ꕥ
┏━ꕥ〔 *llı I N F O  C O M M A N D ıll* 〕ꕥ━⬣
┃✾ *🅟* = Premium
┃✾ *🅛* = Limit
┗━ꕥ
%readmore`.trimStart(),
  ...
  footer: '┗━━━━━━━━━ꕥ\n',
  after: `  ${'✧\n┏━📮 *Note* :\n┃ Disarankan untuk tidak melanggar peraturan jika tidak ingin diban!\n┗━━━━━━━━━━━━━━━━━━━ꕥ'}`,
}
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/5c153385dea29f12da603.jpg'
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        sourceUrl: 'https://instagram.com//ajaja',
                        mediaType: 2,
                        description: `Create by Virzz`,
                        title: `💌 Ultah Owner : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                        body: `Create by Virzz`,          previewType: 0,
                        thumbnail: await (await fetch(giflogo2)).buffer(),
                        mediaUrl: 'https://instagram.com/aderso'
                        
                      }}
})
  } catch (e) {
    conn.reply(m.chat, 'Terdapat kendala! Silahkan coba lagi nanti!', m)
    throw e
  }
  let vn = `./mp3/Virzz.opus`
