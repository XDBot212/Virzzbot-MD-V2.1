...
let handler = async (m, { conn, text, usedPrefix }) => {
    const ultah = new Date('Oktober 4 2022 23:59:59')
...
`
    ...
    return conn.sendButton(m.chat, hiasan, sewa, await (await fetch(`https://telegra.ph/file/5c153385dea29f12da603.jpg`)).buffer(), [["🗳️MENU", usedPrefix + "menu"], ["🔭DONASI", usedPrefix + "donasi"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        mediaType: 2,
